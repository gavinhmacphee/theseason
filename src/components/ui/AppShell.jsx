export default function AppShell({ children, title, emoji, subtitle, onBack, actions }) {
  return (
    <div className="relative max-w-[480px] mx-auto min-h-screen px-4 pb-24">
      <header className="py-4 flex items-center justify-between border-b border-border-light mb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            {emoji && <span className="text-[26px]">{emoji}</span>}
            <div>
